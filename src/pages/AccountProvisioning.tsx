...
import { useCallback, useEffect, useMemo, useState } from 'react';// #18 — Staff account provisioning. Tight single-line rows, Edit name action,
// past-date guarded on the expiry field.
//
// Actions:
//   Edit name         → admin-manage-user { action: 'update_name', new_name }
            ...
            {filtered.map((a) => (
              <tr key={a.profile_id}>
                <td className="mas-cell-strong">
                  {a.full_name && a.full_name !== a.email
