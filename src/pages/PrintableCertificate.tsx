...
const SLOT = {
  ...
  serial: { xPct: 97.5, yPct: 2.5, align: 'right' as const, size: 9,  weight: 'normal' as const },
  date:   { xPct: 97.5, yPct: 4.5, align: 'right' as const, size: 11, weight: 'normal' as const },
...
.mas-cert-slot.slot-serial { top: 2.5%;  right: 2.5%; font-size: 9pt; }
.mas-cert-slot.slot-date   { top: 4.5%;  right: 2.5%; }
