// Minimal inline icon set (Feather-style), no external dependency.
...
const P: Record<string, JSX.Element> = {
  ...
  inbox: <><path d="M22 12h-6l-2 3h-4l-2-3H2" /><path d="M5 6 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6L19 6a2 2 0 0 0-1.8-1H6.8A2 2 0 0 0 5 6z" /></>,
